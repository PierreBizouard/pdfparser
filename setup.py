...
old_poppler_32 = False
if old_poppler_32:
    POPPLER_ROOT = r"D:\local\src\poppler"
    POPPLER_ROOT_POPPLER = r"D:\local\src\poppler\poppler"
    POPPLER_ROOT_CPP = r"D:\local\src\poppler\cpp"
    POPPLER_ROOT_CPP_BUILD = r"D:\local\src\poppler\build"
    POPPLER_ROOT_BUILD = r"D:\local\src\poppler\build\poppler"
    POPPLER_LIB_DIR = r"D:/tools/poppler_msvc/lib"

else:
    POPPLER_ROOT = r"D:\local\src\poppler-22.12.0"
    POPPLER_ROOT_POPPLER = r"D:\local\src\poppler-22.12.0\Library\include"
    POPPLER_ROOT_CPP = r"D:\local\src\poppler-22.12.0\Library\include\poppler\cpp"
    POPPLER_ROOT_CPP_BUILD = r"D:\local\src\poppler-22.12.0\Library\include\poppler\cpp"
    POPPLER_ROOT_BUILD = r"D:\local\src\poppler-22.12.0\Library\include\poppler"
    POPPLER_LIB_DIR = r"D:\local\src\poppler-22.12.0\Library\lib"

if POPPLER_ROOT:
    poppler_ext = Extension('pdfparser.poppler', ['pdfparser/poppler.pyx'], language='c++',
                            extra_compile_args=mac_compile_args if sys.platform == 'darwin' else ["-std:c++17"],
                            include_dirs=[POPPLER_ROOT, POPPLER_ROOT_POPPLER, POPPLER_ROOT,POPPLER_ROOT_CPP,POPPLER_ROOT_CPP_BUILD, POPPLER_ROOT_BUILD],
                            library_dirs=[POPPLER_LIB_DIR],
                            #runtime_library_dirs=["$ORIGIN"],
                            #libraries=['poppler','poppler-cpp', 'advapi32', 'D:\local\src\libs\zlib','C:\mingw\src\lib\openjp2\libopenjp2','D:\local\src\libjpeg\Release\jpeg','C:\mingw\src\lib\openjp2\libopenjp2',r'C:/Anaconda3/Library/lib/libcurl'])
